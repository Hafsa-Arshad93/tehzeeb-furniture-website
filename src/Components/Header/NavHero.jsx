    ...
    <div className="w-full">
      ...
      <header className="w-full bg-yellow-600 body-font">
        <div className="flex flex-wrap p-1 flex-col md:flex-row items-center">
          ...
          <Link
            to="/"
            className="font-medium text-white pl-10 mb-1 mt-1 pr-5"
          >
            <img
              data-aos="fade-right"
              src={tehzeebLogo}
          ...
          >
            <Link
              to="/"
              className="text-yellow-900 text-lg sm:text-xl md:text-2xl   tracking-wider hover:text-yellow-500 transition-colors duration-300"
            >
              Home
            </Link>
            ...
            <div className="relative inline-block">
              <select
                onChange={(e) => {
                  window.location.href = `/collection?category=${e.target.value}`;
                }}
                className="
      appearance-none
      text-yellow-900
